...
# First template, fills everything. No need, see above

# for elements in lessons:
#     # fill first day all time slots. Time slot 1 on monday first
#     # followed by time slot 1 on tuesday etc.
#     if tijd < 4:
#         i = 0
#         array[0][tijd][i] = lessons[c].name
#         c += 1
#         array[1][tijd][i] = lessons[c].name
#         c += 1
#         array[2][tijd][i] = lessons[c].name
#         c += 1
#         array[3][tijd][i] = lessons[c].name
#         c += 1
#         array[4][tijd][i] = lessons[c].name
#         c += 1
#         i += 1
#
#         array[0][tijd][i] = lessons[c].name
